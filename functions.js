//Function
//In JS you don't need to write a type of the return variables
function ourReusableFunction(/* Arguments */){
	//Code
...
//We can use JSON.stringify(*array*) to create a string from array
